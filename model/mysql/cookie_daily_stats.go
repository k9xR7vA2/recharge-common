...
type CookieDailyStats struct {
	...
	StatDate string `gorm:"column:stat_date;not null" json:"statDate"` // "2025-03-06"

	// 存量与流量
	CarryOver int `gorm:"column:carry_over;default:0" json:"carryOver"` // 昨日结转可用数
	...
	// 成本（选填）
	UnitCost  float64 `gorm:"column:unit_cost;default:0"  json:"unitCost"`  // 单个 Cookie 成本
	CostTotal float64 `gorm:"column:cost_total;default:0" json:"costTotal"` // 当日总成本
