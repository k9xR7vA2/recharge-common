...
type SupplierAccount struct {
	...
	Amount          decimal.Decimal `json:"amount"           gorm:"type:decimal(12,2);not null;default:0;comment:待充金额"`
	...
	Status          int             `json:"status"           gorm:"type:tinyint;not null;default:1;comment:1待审核 2审核通过 3充值中 4已完成 5已拒绝 6禁用"`
