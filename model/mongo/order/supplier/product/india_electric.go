...
// SupplierIndiaElectricOrder  印度DTH订单
// DTH 与话费差异：无充值速度、无携号转网，运营商为 DTH 运营商
type SupplierIndiaElectricOrder struct {
	supplier.SupplierOrderBase `bson:",inline"`
	OperatorID                 uint `bson:"operator_id" json:"operator_id"` // DTH 运营商
...
func (o *SupplierIndiaElectricOrder) GetAppID() string { return o.AppID }
func (o *SupplierIndiaElectricOrder) GetOperatorID() uint {
	return o.OperatorID
}
func (o *SupplierIndiaElectricOrder) GetChargeSpeed() constant.ChargeSpeed {
