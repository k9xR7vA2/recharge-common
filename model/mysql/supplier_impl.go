...
type Supplier struct {
	SupplierID      uint                         `json:"supplier_id" gorm:"autoIncrement:true;primaryKey;column:supplier_id;type:int unsigned;not null" `
	...
	Status          constant.GlobalAccountStatus `json:"status" gorm:"column:status;type:tinyint;not null;comment:'状态1开启，2关闭'" `                                // 状态1开启，2关闭
	...
	Tenant TenantView `gorm:"foreignKey:TenantID;references:TenantID" json:"tenant,omitempty"`
}
